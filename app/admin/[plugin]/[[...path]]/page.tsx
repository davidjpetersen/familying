  ...
  try {
    ...
    try {
      ...
      try {
        ...
        AdminPluginComponent = pluginModule.AdminComponent;
      } catch (componentError) {
        // Fallback to direct component import
        try {
          pluginModule = await import(`@/../packages/services/${pluginName}/src/AdminSoundscapesPage`);
          ...
          throw new Error(`Failed to load admin component: ${componentMsg} | ${fallbackMsg}`);
        }
      }
    } catch (error) {
