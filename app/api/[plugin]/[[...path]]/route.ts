...
export async function GET(
  ...
  return handlePluginRoute(request, resolvedParams, 'GET', 'api')
}
...
export async function POST(
  ...
  const resolvedParams = await params
  return handlePluginRoute(request, resolvedParams, 'POST', 'api')
}
...
export async function PUT(
  ...
  const resolvedParams = await params
  return handlePluginRoute(request, resolvedParams, 'PUT', 'api')
}
...
export async function DELETE(
  ...
  const resolvedParams = await params
  return handlePluginRoute(request, resolvedParams, 'DELETE', 'api')
}
